...
class ProxyConfig:
    def __init__(self):
        ...
        self.CHANNEL_ERROR_THRESHOLD = 0.6  # Error threshold (e.g., 60%) to disable a channel

        # Minimum ratio of configs required for a protocol to be considered valid
        self.MIN_PROTOCOL_RATIO = 0.9  # Protocol must have at least 60% of all fetched configs
