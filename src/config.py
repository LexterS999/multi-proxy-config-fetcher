...
class ProxyConfig:
    def __init__(self):
        ...
        self.SOURCE_URLS = [
            ...
            ChannelConfig("https://raw.githubusercontent.com/Barabama/FreeNodes/main/nodes/ndnode.txt"),
            ChannelConfig("https://raw.githubusercontent.com/Barabama/FreeNodes/main/nodes/nodev2ray.txt"),
            ChannelConfig("https://raw.githubusercontent.com/Barabama/FreeNodes/main/nodes/v2rayshare.txt"),
            ...
            ChannelConfig("https://raw.githubusercontent.com/soroushmirzaei/telegram-configs-collector/main/subscribe/protocols/hysteria"),
            ...
            ChannelConfig("https://raw.githubusercontent.com/soroushmirzaei/telegram-configs-collector/main/subscribe/protocols/trojan"),
            ChannelConfig("https://raw.githubusercontent.com/Surfboardv2ray/v2ray-worker-sub/refs/heads/master/sub"),
            ...
            ChannelConfig("https://raw.githubusercontent.com/AvenCores/goida-vpn-configs/refs/heads/main/three_file_vpn.txt"),
            ChannelConfig("https://raw.githubusercontent.com/AvenCores/goida-vpn-configs/refs/heads/main/four_file_vpn.txt"),
        ...
        self.PROTOCOL_CONFIG_LIMITS = {
            "min": 1000,    # Minimum configs required per protocol (default: 3)
            "max": 12000    # Maximum configs allowed per protocol (default: 25)
        }
        ...
        self.MIN_CONFIGS_PER_CHANNEL = 1000     # Minimum configs required from each channel (default: 3)
        self.MAX_CONFIGS_PER_CHANNEL = 12000    # Maximum configs allowed from each channel (default: 50)
        ...
        self.CHANNEL_ERROR_THRESHOLD = 0.6   # Error rate threshold to disable channel (default: 0.7 or 70%)
        ...
        self.RETRY_DELAY = 4            # Delay between retries in seconds (default: 15)
        self.REQUEST_TIMEOUT = 6        # Request timeout in seconds (default: 60)
