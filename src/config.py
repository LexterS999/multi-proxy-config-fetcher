...
class ProxyConfig:
    def __init__(self):
        ...
        self.MAX_CONFIGS_PER_CHANNEL = 9000    # Maximum configs allowed from each channel (default: 50)
        self.MAX_CONFIG_AGE_DAYS = 60        # Maximum age of configs in days (default: 90)
        self.CHANNEL_RETRY_LIMIT = 2        # Maximum retry attempts per channel (default: 10)
        self.CHANNEL_ERROR_THRESHOLD = 0.7   # Error rate threshold to disable channel (default: 0.7 or 70%)
        self.MIN_PROTOCOL_RATIO = 0.5        # Minimum ratio of configs per protocol (default: 0.1 or 10%)
        ...
        self.MAX_RETRIES = 2            # Maximum number of retry attempts (default: 10)
        self.RETRY_DELAY = 2            # Delay between retries in seconds (default: 15)
